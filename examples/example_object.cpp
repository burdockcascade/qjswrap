...
int main() {
    ...
    qjswrap::Value global = engine.global();
   ...
   std::ignore = engine.eval(R"(
    ...
    qjswrap::Value updated_player = global.get_property("Player1");
    ...
    if (updated_player.is_object()) {
        ...
        qjswrap::Value updated_pos = updated_player.get_property("pos");
